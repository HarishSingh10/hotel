        ...
        <div className="space-y-10 animate-fade-in pb-16">
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex flex-col items-center">
                    <h1 className="text-xl font-black text-white tracking-tight italic">Vault Discovery</h1>
                    <p className="text-[10px] font-black text-blue-500 uppercase tracking-widest mt-0.5 italic">Lost & Found Reporting</p>
                </div>
            ...
            <form onSubmit={handleSubmit} className="bg-[#161b22] border border-white/[0.05] rounded-[45px] p-8 space-y-8 shadow-2xl shadow-black/40 relative overflow-hidden">
                ...
                <div className="space-y-4">
                    <label className="text-[11px] font-black uppercase tracking-[0.2em] text-gray-500 ml-4 font-mono">Found Intelligence</label>
                    <div className="grid grid-cols-1 gap-4">
                        <input
                            placeholder="Asset Name (e.g. Blue Wallet, iPhone)"
                            value={name}
                ...
                <div className="space-y-4">
                    <label className="text-[11px] font-black uppercase tracking-[0.2em] text-gray-500 ml-4 font-mono">Evidence Capture</label>
                    <div className="flex items-center gap-6 p-6 bg-[#0d1117] border border-white/[0.05] rounded-[30px] shadow-inner relative overflow-hidden group">
                        ...
                        <div className="flex-1">
                            ...
                            >
                                <LayoutGrid className="w-4 h-4" /> Snap Discovery
                            </label>
                            <p className="text-[8px] text-gray-700 mt-2.5 font-black uppercase tracking-[0.3em] ml-1 leading-relaxed">Identity verification required</p>
                        </div>
                    </div>
                </div>
                ...
                <textarea
                    ...
                    className="w-full bg-[#0d1117] border border-white/[0.05] rounded-[30px] px-8 py-6 text-sm text-white outline-none focus:border-blue-500/50 transition-all font-medium italic placeholder:text-gray-800 resize-none"
                ></textarea>

                <button
                    disabled={submitting}
                    className="w-full h-18 bg-blue-600 hover:bg-blue-500 text-white rounded-[30px] font-black text-[12px] uppercase tracking-[0.4em] shadow-2xl shadow-blue-600/30 transition-all flex items-center justify-center gap-4 active:scale-[0.98] disabled:opacity-50 group italic"
                >
                    {submitting ? (
            ...
            <div className="space-y-6">
                <div className="flex items-center justify-between px-2">
                    <h3 className="text-xs font-black text-white uppercase tracking-[0.3em] italic">Discovery Logs</h3>
                ...
                <div className="space-y-4">
                    {history.length === 0 ? (
                        <div className="py-20 text-center bg-[#161b22] rounded-[40px] border border-dashed border-white/5 opacity-40">
                            ...
                            <p className="text-[9px] font-black uppercase tracking-widest">No assets logged by you yet</p>
                        </div>
                    ) : (
                        history.map((item, i) => (
                            <div key={i} className="bg-[#161b22] border border-white/[0.05] p-6 rounded-[35px] flex items-center justify-between group cursor-pointer hover:bg-white/[0.02] transition-all active:scale-[0.98] shadow-xl shadow-black/30 relative overflow-hidden">
                                ...
                                <div className="flex items-center gap-5 relative z-10">
                                    <div className="w-14 h-14 rounded-2xl bg-[#0d1117] border border-white/5 overflow-hidden shadow-inner">
                                        <img src={item.image || `https://api.dicebear.com/7.x/shapes/svg?seed=${item.id}`} className="w-full h-full object-cover" />
                                    </div>
                                    <div>
                                        <h4 className="text-[15px] font-black text-white italic tracking-tight">{item.name}</h4>
                                ...
                                <div className={cn(
                                    "px-4 py-1.5 rounded-xl text-[8px] font-black uppercase tracking-widest border italic transition-all group-hover:scale-105 shadow-sm",
